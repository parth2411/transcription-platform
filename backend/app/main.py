...
from .routes import auth, transcriptions, knowledge, users, realtime, analytics, folders, calendar, meetings, recording, notes
...
app.include_router(notes.router, prefix="/api", tags=["Meeting Notes"])
